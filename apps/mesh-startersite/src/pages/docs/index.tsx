          ...
          >
            ...
            <div className="flex gap-2">
              {doc.frontmatter.difficulty && (
                <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full font-mono font-medium">
                  {doc.frontmatter.difficulty}
                </span>
              )}
              {doc.frontmatter.persona && (
                <span className="px-3 py-1 bg-secondary/10 text-secondary text-sm rounded-full font-mono font-medium">
                  {doc.frontmatter.persona}
                </span>
              )}
            </div>
